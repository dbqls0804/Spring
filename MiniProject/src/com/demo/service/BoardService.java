...
public class BoardService {
	...
	// 글 인덱스 번호로 검색해서 글 정보를 modifyContentBean에 입력한다.
	...
	public void modifyContentInfo(ContentBean modifyContentBean) {
		// 업로드 파일이 있을 경우에 이름(content file)을 입력한다.
		...
		boardMapper.addContentInfo(modifyContentBean);
	}
